...
<form action="crudConsolas.php" method="post">
    <div class="form-group">
        <label for="id_consola">ID de la Consola a eliminar:</label>
        <input type="number" class="form-control" name="id_consola" required>
    </div>

    <input type="hidden" name="delete_consola" value="true">
    <button type="submit" class="btn btn-danger">Eliminar Consola</button>
</form>
    </div>
